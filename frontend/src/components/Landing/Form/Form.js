    ...
    try {
      if (formType == "login") {
        ...
        const resp = await axios.post(
          "https://mern-movie-app.onrender.com/login_post",
          reqData
        );
        if (resp.data.error) {
          let msg;
        ...
        const resp = await axios.post(
          "https://mern-movie-app.onrender.com/signup_post",
          reqData
        );
        if (resp.data.error) {
          let msg;
    ...
    <React.Fragment>
      <div className="form-wrap">
        <div className="switch-forms">
          <div
            className={`form-type ${formType == "login" ? "clicked" : ""}`}
            onClick={loginFormHandler}
          >
            Login
          </div>
          <div
            className={`form-type ${formType == "signup" ? "clicked" : ""}`}
