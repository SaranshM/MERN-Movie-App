...
const Dashboard = (props) => {
    ...
    const getTrendingMovies = useCallback(async () => {
        ...
        const trendingResponse = await axios.post("http://localhost:9000/trending_movies", { page: trendingPage }, { 
            headers: {
    ...
    const getPopularMovies = useCallback(async () => {
        ...
        const popularResponse = await axios.post("http://localhost:9000/popular", { page: popularPage }, { 
            headers: {
                "_id": ctx.appState.userDetails._id, 
                "token": ctx.appState.userDetails.token 
            }
    ...
    const getTopRatedMovies = useCallback(async () => {
        ...
        const topRatedResponse = await axios.post("http://localhost:9000/top_rated", { page: topRatedPage }, { 
            headers: {
                "_id": ctx.appState.userDetails._id, 
                "token": ctx.appState.userDetails.token 
            }
    ...
    const getGenreMovies = useCallback(async () => {
        setGenreLoader(true)
        const genreResponse = await axios.post("http://localhost:9000/genre", { page: genrePage, genre: genre }, { 
            headers: {
                "_id": ctx.appState.userDetails._id, 
                "token": ctx.appState.userDetails.token 
            }
    ...
    const getSearchMovies = useCallback(async () => {
        ...
        const searchResponse = await axios.post("http://localhost:9000/search", { page: searchPage, query: search }, { 
            headers: {
                "_id": ctx.appState.userDetails._id, 
                "token": ctx.appState.userDetails.token 
            }
    ...
    const getStarredMovies = useCallback(async () => {
        ...
        const starredResponse = await axios.post("http://localhost:9000/starred", { _id: ctx.appState.userDetails._id, page: starredPage }, { 
            headers: {
                "_id": ctx.appState.userDetails._id, 
                "token": ctx.appState.userDetails.token 
            }
    ...
    const unStarHandler = (id) => {
        ...
        const tempStarredMovies = starredMovies[0].filter((movie) => { return movie.id != id })
    ...
    return (
        <div className = "dashboard">
            <SearchParams onChangeGenre = {changeGenreHandler} onSubmitQuery = {submitQueryHandler}/>
            {ctx.appState.page == "dashboard" && (
                <div className = "dashboard-blocks">
                    {trendingError.errorState && (
                        <MovieBlock heading = "Trending" movies = {trendingMovies} onMoreMovies = {moreMoviesHandler} error = {trendingError} loader = {trendingLoader}/>
                    )}
                    {!trendingError.errorState && (
                        <MovieBlock heading = "Trending" movies = {trendingMovies} onMoreMovies = {moreMoviesHandler}  error = {trendingError} loader = {trendingLoader}/>
                    )}
                    {popularError.errorState && (
                        <MovieBlock heading = "Popular" movies = {popularMovies} onMoreMovies = {moreMoviesHandler}  error = {popularError} loader = {popularLoader}/>
                    )}
                    {!popularError.errorState && (
                        <MovieBlock heading = "Popular" movies = {popularMovies} onMoreMovies = {moreMoviesHandler}  error = {popularError} loader = {popularLoader}/>
                    )}
                    {topRatedError.errorState && (
                        <MovieBlock heading = "Top-Rated" movies = {topRatedMovies} onMoreMovies = {moreMoviesHandler} error = {topRatedError} loader = {topRatedLoader}/>
                    )}
                    {!topRatedError.errorState && (
                        <MovieBlock heading = "Top-Rated" movies = {topRatedMovies} onMoreMovies = {moreMoviesHandler} error = {topRatedError} loader = {topRatedLoader}/>
                    )}
            ...
            {ctx.appState.page == "genre" && (
                <div className = "dashboard-blocks">
                    {genreError.errorState && (
                        <MovieBlock heading = "Genre" movies = {genreMovies} onMoreMovies = {moreMoviesHandler} error = {genreError} loader = {genreLoader}/>
                    )}
                    {!genreError.errorState && (
                        <MovieBlock heading = "Genre" movies = {genreMovies} onMoreMovies = {moreMoviesHandler} error = {genreError} loader = {genreLoader}/>
                    )}
            ...
            {ctx.appState.page == "search" && (
                <div className = "dashboard-blocks">
                    {searchError.errorState && (
                        <MovieBlock heading = "Search" movies = {searchMovies} onMoreMovies = {moreMoviesHandler} error = {searchError} loader = {searchLoader}/>
                    )}
                    {!searchError.errorState && (
                        <MovieBlock heading = "Search" movies = {searchMovies} onMoreMovies = {moreMoviesHandler} error = {searchError} loader = {searchLoader}/>
                    )}
            ...
            {ctx.appState.page == "starred" && (
                <div className = "dashboard-blocks">
                    {starredError.errorState && (
                        <MovieBlock heading = "Starred" movies = {starredMovies} onMoreMovies = {moreMoviesHandler} error = {starredError} loader = {starredLoader}/>
                    )}
                    {!starredError.errorState && (
                        <MovieBlock heading = "Starred" movies = {starredMovies} onMoreMovies = {moreMoviesHandler} error = {starredError} loader = {starredLoader}/>
                    )}
            ...
            {ctx.appState.overlay && (
                <Overlay onCloseOverlay = {closeOverlayHandler} onUnStar = {unStarHandler}/>
            )}
        </div>
    )
}
