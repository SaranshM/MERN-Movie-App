  ...
  useEffect(async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://mern-movie-app.onrender.com/auto_login",
        reqData
      );
      setLoading(false);
      console.log(data);
  ...
  const logoutHandler = async () => {
    try {
      ...
      const resp = await axios.post(
        "https://mern-movie-app.onrender.com/logout",
        reqData
      );
    ...
    >
      ...
      {loading ? (
        ...
        <div className="app">
          ...
          />
          {!appState.loggedIn && appState.page == "landing" && (
            <Form onLoginSignup={loginSignupHandler} />
          )}
          {appState.loggedIn &&
            (appState.page == "dashboard" ||
              ...
              <Dashboard starred={appState.page == "starred" ? true : false} />
            )}
        </div>
      )}
    </SessionContext.Provider>
